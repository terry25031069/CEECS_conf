...
def agenda():
    schedule = [
        ...
        },
        {
            ...
            "divname": "day2",
            "events": [
                {"time": "09:00 ~ 09:30", "description": ["開幕致詞"], "colspan": 4, "type": "1"},
                ...
                {"time": "13:30 ~ 15:00", "description": ["【研討會 A1】  通訊工程/電路設計  工程五館 A203", "【研討會 B1】  多媒體處理/資訊安全  工程五館 A301", "【研討會 C1】  醫療工程/深度學習  工程五館 A302"], "colspan": 1, "type": "1"},
                {"time": "15:00 ~ 15:30", "description": ["茶敘"], "colspan": 4, "type": "0"},
                {"time": "15:30 ~ 17:00", "description": ["【研討會 A2】  資料處理工程  工程五館 A203", "【研討會 B2】  資料傳輸工程  工程五館 A301", "【研討會 C2】  資料庫工程/學習科技   A302"], "colspan": 1, "type": "1"},
                {"time": "18:30 ~ 21:00", "description": ["晚宴"], "colspan": 4, "type": "1"}
            ]
        },
        {
            "date": "11月29日(星期三)",
